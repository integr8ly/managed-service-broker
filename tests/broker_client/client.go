...
func (sbc *ServiceBrokerClient) Catalog() (*http.Response, *CatalogResponse, *ServiceBrokerError) {
	...
	req, err := createRequest(http.MethodGet, url, "", sbc.Token, sbc.UserIdentity);if err != nil {
		return nil, nil, err
	}
...
func (sbc *ServiceBrokerClient) CreateServiceInstance(
	...
	acceptsIncomplete bool) (*http.Response, *ServiceInstanceResponse, *ServiceBrokerError) {
		...
		req, err := createRequest(http.MethodPut, url, fmt.Sprintf(data, planId, serviceId, namespace), sbc.Token, sbc.UserIdentity);if err != nil {
			return nil, nil, err
		}
...
func (sbc *ServiceBrokerClient) DeleteServiceInstance(
	...
	acceptsIncomplete bool) (*http.Response, *DeleteResponse, *ServiceBrokerError) {
		...
		req, err := createRequest(http.MethodDelete, url, "", sbc.Token, sbc.UserIdentity);if err != nil {
			return nil, nil, err
		}
...
func (sbc *ServiceBrokerClient) GetServiceBindingLastOperation(
	...
	operation string) (*http.Response, *LastOperationResponse, *ServiceBrokerError) {
		...
		res, obj, err := doRequest(req, sbc.HttpClient, &LastOperationResponse{});if err != nil {
			return res, nil, err
		}
...
func (sbc *ServiceBrokerClient) GetServiceInstance(instanceId string) (*http.Response, *GetServiceInstanceResponse, *ServiceBrokerError) {
	...
	res, obj, err := doRequest(req, sbc.HttpClient, &GetServiceInstanceResponse{});if err != nil {
		return res, nil, err
	}
...
func (sbc *ServiceBrokerClient) UpdateServiceInstance(
	...
	acceptsIncomplete bool) (*http.Response, *ServiceInstanceResponse, *ServiceBrokerError) {
		...
		req, err := createRequest(http.MethodPatch, url, fmt.Sprintf(data, planId, serviceId), sbc.Token, sbc.UserIdentity);if err != nil {
			return nil, nil, err
		}
		res, obj, err := doRequest(req, sbc.HttpClient, &ServiceInstanceResponse{});if err != nil {
			return res, nil, err
		}
...
func (sbc *ServiceBrokerClient) CreateServiceInstanceBinding(
	...
	acceptsIncomplete bool) (*http.Response, *BindingResponse, *ServiceBrokerError) {
		...
		req, err := createRequest(http.MethodPut, url, fmt.Sprintf(data, planId, serviceId), sbc.Token, sbc.UserIdentity);if err != nil {
			return nil, nil, err
		}
		res, obj, err := doRequest(req, sbc.HttpClient, &BindingResponse{});if err != nil {
			return res, nil, err
		}
...
func (sbc *ServiceBrokerClient) DeleteServiceInstanceBinding(
	...
	acceptsIncomplete bool) (*http.Response, *DeleteResponse, *ServiceBrokerError) {
		...
		res, obj, err := doRequest(req, sbc.HttpClient, &DeleteResponse{});if err != nil {
			return res, nil, err
		}
...
func createRequest(method, url, data, token, userIdentity string) (*http.Request, *ServiceBrokerError) {
	req, err := http.NewRequest(method, url, bytes.NewBufferString(data)); if err != nil {
