...
type Deployer interface {
	...
	LastOperation(req *brokerapi.LastOperationRequest) (*brokerapi.LastOperationResponse, error)
...
func (c *userProvidedController) LastOperation(req *brokerapi.LastOperationRequest) (*brokerapi.LastOperationResponse, error) {
	glog.Info("LastOperation()", "operation "+req.Operation, req.ServiceID)

	deployer := c.getDeployer(req.ServiceID)
	if deployer != nil {
		return deployer.LastOperation(req)
	}
